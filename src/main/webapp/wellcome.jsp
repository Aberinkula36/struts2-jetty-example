...
<body>
    ...
    <p><strong>Fecha 'Date from':</strong> <s:date name="invoiceBean.dateFrom" format="MM/dd/yyyy"/></p>
    <p><strong>Fecha 'Date to':</strong> <s:date name="invoiceBean.dateTo" format="MM/dd/yyyy"/></p>
